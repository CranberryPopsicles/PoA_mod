...
var UIPopup = load("res://Scenes/UI_Popup.tscn")
var UIPopupNongame = load("res://Scenes/UI_Popup_Nongame.tscn")
var UILog = load("res://Scenes/UI_Log.tscn")
var UIMenu = load("res://Scenes/UI_GameMenu.tscn")
