...
static func trait_name_plain(label):
	var names = {
		...
		"Deadly Feast": "致命盛宴",
		"Absorb Time": "吸收时间",
		"Entangling Touch": "缠绕之触",
		"Entangling Aura": "缠绕光环",
		"Bleeding Touch": "流血之触",
		...
		"Astral Casting": "星界施法",
		"Poison Casting": "毒素施法",
		"Wandering Poison": "游走毒素",
		"Death Casting": "死亡施法",
		"Gesture of Death": "死亡手势",
		"Ill Manica": "恶兆臂甲",
		"Chilling Touch": "寒冷之触",
		"Freezing Gesture": "冻结手势",
		"Burning Gesture": "燃烧手势",
		"Thundering Gesture": "雷鸣手势",
		"Counter": "反击",
		"Violet Destruction": "紫罗兰毁灭",
		"Disruption": "扰乱",
		"Subtle Pierce": "隐秘穿刺",
		"Frenzy": "狂乱",
		"Channel Harm": "引导伤害",
		...
		"Dread Vengeance": "恐惧复仇",
		"Sharpened Death": "锋锐死亡",
		"Heavy Cleave": "重劈",
		"Polyumbra": "复影",
		"Golden Servant": "黄金仆从",
		"Sacred Skin": "圣洁皮肤",
		"Blood of Mardok": "马尔多克之血",
		"Self-Abnegation": "自我舍弃",
		"Appendage of Oros": "奥罗斯附肢",
		"Impaling Flame": "贯穿火焰",
		"Immaculate": "无瑕",
		"Fireblade": "火焰刃",
		"Firecrush": "火焰碾压",
		...
		"Packmaster": "兽群领主",
		"Parapoison": "麻痹毒素",
		"Sickening Touch": "疾病之触",
		"Sickening Skin": "疾病皮肤",
		"Ratmaster": "鼠群领主",
		"Banner-Rat": "旗鼠",
		"Protection from Astral": "星界防护",
		"Protection from Blunt": "钝击防护",
		"Protection from Death": "死亡防护",
		"Protection from Fire": "火焰防护",
		"Protection from Ice": "寒冰防护",
		"Protection from Lightning": "闪电防护",
		"Protection from Pierce": "穿刺防护",
		"Protection from Poison": "毒素防护",
		"Protection from Psychic": "灵能防护",
		"Protection from Slash": "斩击防护",
		"Protection from Blood": "鲜血防护",
		"Scourge": "灾祸",
		"Cosmic Sigil": "宇宙符印",
		"Vile Sigil": "邪秽符印",
		"Flame Sigil": "火焰符印",
		...
		"Mind Sigil": "心灵符印",
		"Emerald Eye": "翡翠之眼",
		"Emerald Chakram": "翡翠轮刃",
		"Berserker Staff": "狂战士法杖",
		"Paralyzing Touch": "麻痹之触",
		"Spite": "怨毒",
		"Stationary": "站定",
		"Summon Dancing Flesh": "召唤舞动血肉"
	}
	if names.has(label):
		return names[label]
	return label
