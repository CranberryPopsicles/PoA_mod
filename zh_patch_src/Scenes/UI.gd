...
func update():
	...
	var stringa = "[color=#ffff50]" + str(Global.Player.get_name()) + "[/color][color=#c0c0c0]，[/color]" + StatePlayerSheet.title_race + " " + StatePlayerSheet.title_class + "[color=#c0c0c0]，信仰[/color] " + StatePlayerSheet.God.name
