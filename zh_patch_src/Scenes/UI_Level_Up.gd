...
var disabled = true
var reward_text = "[color=#a0a0a0]选择一项属性提升..."
...
func write_hero_manual():
	...
	stringa += "     [color=#30a030]速度 " + speed_color + str(Global.Player.get_SPEED()) + " [color=#707070](" + str(Global.Player.get_SPEED_min()) + ")"
	...
	stringa += "     [color=#a03030]负重 " + enc_color + str(Global.Player.get_total_weight()) + " [color=#707070]-" + str(Global.Player.get_total_STR()) + ""
