...
func update_text():
	...
	"[center][color=#ff7050]Strength[/color]", 
	"[center][color=#50ff70]Dexterity[/color]", 
	"[center][color=#c050ff]Willpower[/color]", 
	"[center][color=#ff8080]Vigor[/color]", 
	"[center][color=#ff2090]Random[/color]"]
	
	
	match list[ToolSettings.settings_data.auto_level]:
			"[center][color=#808080]none[/color]":
				textbox.bbcode_text = "[right][color=#707070]...[/color]"
			"[center][color=#ff7050]Strength[/color]":
				textbox.bbcode_text = "[right][color=#ffff50]+[/color] [color=#ff7050]STR[/color]"
			"[center][color=#50ff70]Dexterity[/color]":
				textbox.bbcode_text = "[right][color=#ffff50]+[/color] [color=#50ff70]DEX[/color]"
			"[center][color=#c050ff]Willpower[/color]":
				textbox.bbcode_text = "[right][color=#ffff50]+[/color] [color=#c050ff]WIL[/color]"
			"[center][color=#ff8080]Vigor[/color]":
				textbox.bbcode_text = "[right][color=#ffff50]+[/color] [color=#ff8080]VIG[/color]"
			"[center][color=#ff2090]Random[/color]":
				textbox.bbcode_text = "[right][color=#ff2090]随机[/color]"
