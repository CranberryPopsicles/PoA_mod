...
func _ready():
	var stringa = "[color=#ffff50]" + str(Global.Player.get_name()) + "[/color][color=#c0c0c0]，[/color] " + StatePlayerSheet.title_race + " " + StatePlayerSheet.title_class + " [color=#c0c0c0]信奉[/color] " + StatePlayerSheet.God.name
	stringa += "\n\n"
	stringa += "[color=#707070]"
	stringa += "[color=#ff5050]" + str(StatePlayerSheet.score_data.game_turns) + "[/color] 个游戏回合已过去"
	stringa += "\n\n"
