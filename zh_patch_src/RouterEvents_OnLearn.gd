...
static func check(label, msg):
	...
	match label:
		...
		"GoreTide":
				ToolMessageCreator.add_message("[color=#a0c0c0]", "[color=#ff1010]Gore Tide[/color]！[color=#707070]+50 生命[/color]")
				if ToolSettings.settings_data.cycle_current > 1:
					...
					ToolMessageCreator.add_message("[color=#ff5050]", "轮回使你焕发生机...[color=#707070] +" + str(int(hp_bonus)) + " 生命[/color]")
		...
		"Kuga":
				ToolMessageCreator.add_message("[color=#a0c0c0]", "[color=#a0a000]Kuga[/color]！[color=#707070]+50 生命[/color]")
				if ToolSettings.settings_data.cycle_current > 1:
					var hp_bonus = float(4)
					hp_bonus *= float(ToolSettings.settings_data.cycle_current)
					Global.Player.HP_max += int(hp_bonus)
		...
		"Merzot":
				ToolMessageCreator.add_message("[color=#a0c0c0]", "[color=#70ff00]Merzot[/color]！[color=#707070]+50 生命[/color]")
				if ToolSettings.settings_data.cycle_current > 1:
		...
		"AmplifiedHealing":
				ToolMessageCreator.add_message("[color=#a0c0c0]", "[color=#00a000]Life Chant[/color]！[color=#707070]+50 生命[/color]")
				if ToolSettings.settings_data.cycle_current > 1:
					var hp_bonus = float(4)
					hp_bonus *= float(ToolSettings.settings_data.cycle_current)
					Global.Player.HP_max += int(hp_bonus)
		...
		"Anroth":
			ToolMessageCreator.add_message("[color=#309fbf]", "Anroth 的灵魂在你体内奔涌！[/color]")
